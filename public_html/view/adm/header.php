...
if($status == Status::ONLINE || $status == Status::ACTIVE) {
    (new Navbar)->addLi("Etudiants", APP_DOMAIN . "adm/students", $params['nav_item_active'] == "Etudiants")
        ->addLi("Professeurs", APP_DOMAIN . "adm/professors", $params['nav_item_active'] == "Professeurs")
