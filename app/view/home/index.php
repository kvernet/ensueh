...
<div class="dashboard-content px-3 pt-4">
    <div class="jumbotron">
        <h2 class="display-6">Présentation de l'<?php echo COMPLETE_SITE_NAME; ?></h2>
        <p class="lead">L'<?php echo COMPLETE_SITE_NAME . " (" . SITE_NAME . ")"; ?> est une entité de l'<?php echo UEH; ?> qui a pour vocation de former des universitaires de haut niveau, des enseignants, des chercheurs et des professeurs destinés à l’enseignement secondaire.
            Elle offre des formations de premier et de deuxième cycles dans différents domaines. Elle comprend actuellement les sept (7) <a href="./departements">départements</a> qui suivent: Lettres modernes, Philosophie, Sciences Sociales, Langues vivantes, Mathématiques, Physique, Sciences Naturelles.
    ...
    <div class="jumbotron">
        <h2 class="display-6">Historicité de ENS</h2>
        <p class="lead">
    ...
    <div class="jumbotron">
        <h2 class="display-6">Vision de ENS</h2>
        <p class="lead">
            L'<?php echo SITE_NAME; ?> a pour vision de:
        <ul class="lead">
